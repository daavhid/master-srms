                    ...
                    render={({field})=>(
                        <FormItem>
                            ...
                            <div className='bg-white flex items-center px-2 '>
                                ...
                                <Input className={cn(' font-[500] outline-none border-none focus-visible:ring-0 rounded-none py-6  focus-visible:ring-transparent focus-visible:ring-offset-0  ')} type='email' placeholder='Email Address' {...field} disabled={isLoading}/>
                            </div>
                            </FormControl>
                            <FormMessage/>
                        </FormItem>
                    ...
                    render={({field})=>(
                        <FormItem>
                            ...
                            <div className='bg-white flex items-center px-2 '>
                                ...
                                <Input className={cn(' font-[500] outline-none border-none focus-visible:ring-0 rounded-none py-6  focus-visible:ring-transparent focus-visible:ring-offset-0  ')} type='password' placeholder='Password' {...field} disabled={isLoading}/>
                            </div>   
                            </FormControl>
                            <FormMessage/>
                        </FormItem>
