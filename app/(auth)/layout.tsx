...
const layout = ({children}:{children:React.ReactNode}) => {
  return (
    ...
    after:absolute after:-z-10 z-10  after:opacity-70 after:bg-black after:w-full after:h-full after:top-0 after:left-0'>
        <div className='flex md:flex-row flex-col items-center md:justify-around justify-evenly h-full z-30 '>
            <h1 className={cn('text-white md:hidden text-2xl font-semibold z-50',nunito.className)}>RESULT MANAGEMENT SYSTEM</h1>
            <div className={cn('text-white hidden md:block',nunito.className)}>
